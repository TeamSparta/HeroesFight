namespace HeroesFight.Entities.Commands
{
    ...
    public class InitializeLevelOneCommand : ICommand
    {
        ...
        private static void DrawEnemyInfo(IDatabase database, FirstLevelRoundOneState state, Graphics graphics)
        {
            ...
            graphics.DrawString("HP:", new Font(FontFamily.GenericMonospace, 12), new SolidBrush(Color.DarkGray), 500, 57);
            graphics.DrawString("Mana:", new Font(FontFamily.GenericMonospace, 12), new SolidBrush(Color.DarkGray), 500, 81);
        ...
        private static void DrawPlayerInfo(IDatabase database, FirstLevelRoundOneState state, Graphics graphics)
        {
            ...
            graphics.DrawString("HP:", new Font(FontFamily.GenericMonospace, 12), new SolidBrush(Color.DarkGray), 70, 57);
            graphics.DrawString("Mana:", new Font(FontFamily.GenericMonospace, 12), new SolidBrush(Color.DarkGray), 70, 81);
